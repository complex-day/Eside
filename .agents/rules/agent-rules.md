...
2. Create or update knowledge/Mx-name.md

Knowledge document must include:
...
The knowledge document is written for the project owner and should enable them to understand and eventually rebuild the milestone without AI assistance.