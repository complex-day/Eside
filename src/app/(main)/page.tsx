    ...
    <div className="flex flex-col items-center justify-center space-y-10 py-6 sm:py-12 text-center">
      ...
      <div className="max-w-2xl space-y-4">
        <div className="inline-flex items-center space-x-2 rounded-full border border-primary/30 bg-primary/10 px-3.5 py-1 text-xs font-medium text-primary">
          ...
          <span>Eside Platform — Anonymous Lived Experiences</span>
        </div>
        ...
        <div className="pt-3 flex flex-col sm:flex-row items-center justify-center gap-3">
          <Link href="/register" className="w-full sm:w-auto">
            <Button size="lg" className="w-full sm:w-auto font-medium h-10 text-xs sm:text-sm">
              Join Anonymously
              <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
          </Link>
          <Link href="/login" className="w-full sm:w-auto">
            <Button variant="outline" size="lg" className="w-full sm:w-auto h-10 text-xs sm:text-sm">
              Sign In
            </Button>
          </Link>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full text-left">
        <Card className="border-border/60 bg-surface-card backdrop-blur-sm shadow-sm">
          <CardHeader className="pb-2">
            <div className="h-8 w-8 rounded-lg bg-primary/20 flex items-center justify-center text-primary mb-2">
              <ShieldCheck className="h-4 w-4" />
            </div>
            <CardTitle className="text-base font-semibold">Safe Anonymity</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-border/60 bg-surface-card backdrop-blur-sm shadow-sm">
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-base font-semibold">Outcome Timelines</CardTitle>
          </CardHeader>
          <CardContent>
            <CardDescription className="text-xs leading-relaxed text-muted-foreground">
        ...
        <Card className="border-border/60 bg-surface-card backdrop-blur-sm shadow-sm">
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-base font-semibold">Collective Insights</CardTitle>
          </CardHeader>
          <CardContent>
            <CardDescription className="text-xs leading-relaxed text-muted-foreground">
      ...
      <Card className="w-full border-border/80 bg-surface-card/60 text-left shadow-sm">
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <CardTitle className="text-sm font-semibold flex items-center space-x-2">
              <span className="h-2 w-2 rounded-full bg-emerald-400 animate-pulse" />
              <span>Milestone 3: Auth &amp; Profiles Active</span>
            </CardTitle>
        ...
        <CardContent className="space-y-2 text-xs text-muted-foreground font-mono">
          <div className="flex justify-between py-1 border-b border-border/40">
            ...
            <span className="text-foreground font-sans">Supabase Auth + Edge Session Cookies</span>
          </div>
          <div className="flex justify-between py-1 border-b border-border/40">
            <span>Identity Model:</span>
            <span className="text-foreground font-sans">Anonymous Profiles with Case-Insensitive Handles</span>
          </div>
          <div className="flex justify-between py-1 border-b border-border/40">
            <span>Security Layer:</span>
            <span className="text-foreground font-sans">PostgreSQL RLS (20 Policies Active)</span>
          </div>
          <div className="flex justify-between py-1">
            <span>Profile Structure:</span>
            <span className="text-foreground font-sans">Published, Drafts, Archived, Outcomes, Bookmarks</span>
          </div>
        </CardContent>
      </Card>
    </div>
