...
export function TabsList({
  ...
  return (
    <div
      className={cn(
        "inline-flex h-10 items-center justify-start rounded-lg bg-surface-card p-1 text-muted-foreground border border-border overflow-x-auto max-w-full scrollbar-none",
        className
      )}
      {...props}
    >
    ...
    <button
      ...
      className={cn(
        ...
        isSelected
          ...
          : "hover:bg-slate-800/60 hover:text-foreground",
        className
      )}
      {...props}
    >
