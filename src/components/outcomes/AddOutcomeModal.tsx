...
export function AddOutcomeModal({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-xl max-h-[90dvh] flex flex-col rounded-2xl glass-card bg-[#090B0F]/98 text-[#F1F5F9] shadow-2xl relative border border-white/[0.08] overflow-hidden"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Fixed Modal Header */}
        <div className="shrink-0 flex items-start justify-between gap-3 border-b border-white/[0.08] p-4 sm:p-5">
        ...
        >
          <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-4 overscroll-contain">
            ...
            <div className="space-y-1.5">
              ...
              {activeTab === "write" ? (
                ...
                <div className="w-full min-h-[100px] rounded-lg border border-white/[0.08] bg-black/60 p-3 text-xs sm:text-sm text-[#CBD5E1] leading-relaxed whitespace-pre-line">
          ...
          <div className="shrink-0 flex items-center justify-end gap-2 p-3 sm:p-4 border-t border-white/[0.08] bg-[#090B0F]/95 backdrop-blur-md">
            <Button
              type="button"
              variant="outline"
              size="sm"
