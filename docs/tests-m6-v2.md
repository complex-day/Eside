# TDD Test Suite: Milestone 6 V2 (Living Outcome Journeys & Longitudinal Discovery Engine)
...
All tests are specified **before** writing implementation code. The TDD execution order follows 6 sequential test suites:

```text
Phase 1: Validation Unit Tests (Optional days_after & 0-3650 bounds)
Phase 2: Elapsed Time Auto-Calculation Logic Unit Tests
Phase 3: Living Journey API Route Integration Tests (POST & GET outcomes)
Phase 4: Outcome Discovery & Feed Ranking Tests (Recently Updated & Journey Depth)
...
### Suite 4: Outcome Discovery & Feed Ranking Tests (`GET /api/v1/experiences`)
...
Implementation of Milestone 6 V2 will be verified by:
